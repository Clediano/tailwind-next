  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="space-x-3">
        <button className="rounded px-3 py-2 text-sm font-medium text-violet-500 dark:text-zinc-300 dark:hover:text-zinc-100">
          Dimiss
        </button>
        <button className="rounded px-3 py-2 text-sm font-medium text-violet-700 dark:text-violet-300 dark:hover:text-violet-100">
          Upgrade plan
        </button>
      </div>
    </div>
