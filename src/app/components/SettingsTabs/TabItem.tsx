...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    ...
    >
      <span className="whitespace-nowrap rounded group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4 dark:text-zinc-400 dark:data-[state=active]:text-violet-300">
        {title}
      </span>
